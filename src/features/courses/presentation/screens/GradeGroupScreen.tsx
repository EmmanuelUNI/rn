...
export default function GradeGroupScreen() {
  ...
  const { getMyGroupInActivity, hasEvaluated, submitEvaluation } = useCourses();
      ...
      <View style={styles.content}>
        {loading ? (
          ...
          <View style={styles.center}>
            <Text style={styles.emptyText}>No perteneces a ningún grupo en esta actividad</Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  content:        { flex: 1, backgroundColor: '#FFFFFF', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 18 },
  center:         { flex: 1, alignItems: 'center', justifyContent: 'center' },
  emptyText:      { color: '#666', fontSize: 14, textAlign: 'center' },
  errorText:      { color: '#e74c3c', fontSize: 14 },
  scroll:         { paddingBottom: 20 },
  memberCard:     { borderRadius: 10, borderWidth: 1, borderColor: '#B8ADD0', marginBottom: 16, overflow: 'hidden' },
  ...
  criterionLabel: { flex: 2, padding: 10, borderRightWidth: 1, borderRightColor: '#D3CBE3', justifyContent: 'center' },
  ...
  btn:            { backgroundColor: COLORS.primary, borderRadius: 24, paddingVertical: 12, paddingHorizontal: 18 },
